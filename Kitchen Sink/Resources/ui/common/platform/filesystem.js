function filesystem(_args) {
	...
	var testtt = Ti.Filesystem.getFile(Ti.Filesystem.resourcesDirectory, 'etc/text_two.txt');
	testtt.write("sadsadsa123", true);
	Ti.API.info(testtt.read().text);
	
	
	
	if(!testfile.write("text written via write() ok\n")) {
